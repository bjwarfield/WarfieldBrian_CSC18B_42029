...
public class EnemyEntity extends Entity {
    ...
    public void shoot3Way(PlayerEntity ship) {
        ...
        //spawn bullet at bottom middle of ship sprite (or wherever the guns will be)
        EnemyShotEntity shot2 = new EnemyShotEntity(this.game, (int) x+(this.sprite.getWidth()/2)-4, (int) y+(this.sprite.getHeight()), "sprites/enemyShot1a.png");
        game.addShot(shot2);
        //target player ship. scale diagonal shotSpeed using trig functions 
        shot2.setHorizontalMovement((float)(shot.getShotSpeed()*((xDiff/hyp)+Math.sin(1))));
        shot2.setVerticalMovement((float)(shot.getShotSpeed()*((yDiff/hyp)+Math.cos(1))));
        
//        //spawn bullet at bottom middle of ship sprite (or wherever the guns will be)
//        EnemyShotEntity shot3 = new EnemyShotEntity(this.game, (int) x+(this.sprite.getWidth()/2)-4, (int) y+(this.sprite.getHeight()), "sprites/enemyShot1a.png");
//        game.addShot(shot3);
//        //target player ship. scale diagonal shotSpeed using trig functions 
//        shot3.setHorizontalMovement((float)(shot.getShotSpeed()*((xDiff/hyp)+Math.sin(-5))));
//        shot3.setVerticalMovement((float)(shot.getShotSpeed()*((yDiff/hyp)+Math.sin(-5))));
    }
